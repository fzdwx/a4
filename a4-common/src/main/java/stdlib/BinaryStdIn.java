...
public final class BinaryStdIn {
   ...
   /**
     ...
     * @throws java.util.NoSuchElementException if there are fewer than 8 bits available on standard input
     */
   ...
   /**
     ...
     * @throws java.util.NoSuchElementException if there are fewer than {@code r} bits available on standard input
   ...
   /**
     ...
     * @throws java.util.NoSuchElementException if standard input is empty or if the number of bits
   ...
   /**
     ...
     * @throws java.util.NoSuchElementException if there are fewer than 16 bits available on standard input
     */
   ...
   /**
     ...
     * @throws java.util.NoSuchElementException if there are fewer than 32 bits available on standard input
     */
   ...
   /**
     ...
     * @throws java.util.NoSuchElementException if there are fewer than 64 bits available on standard input
     */
