 ...
 *  throws an {@link java.util.InputMismatchException}.
 *  <p>
 ...
 *  using the locale {@link java.util.Locale#US}; the rules
 ...
 *  {@code StdIn} and {@link java.util.Scanner} are both designed to parse
 ...
 *       {@link java.util.Scanner} supports arbitrary delimiter patterns.
 *  <li> {@code StdIn} coerces the character-set encoding to UTF-8,
 *       which is the most widely used character encoding for Unicode.
 *  <li> {@code StdIn} coerces the locale to {@link java.util.Locale#US},
...
public final class StdIn {
   ...
   /**
     ...
     * @throws java.util.NoSuchElementException if standard input is empty
     */
   ...
   /**
     ...
     * @throws java.util.NoSuchElementException if standard input is empty
     * @throws java.util.InputMismatchException if the next token cannot be parsed as an {@code int}
     */
   ...
   /**
     ...
     * @throws java.util.NoSuchElementException if standard input is empty
     * @throws java.util.InputMismatchException if the next token cannot be parsed as a {@code double}
     */
   ...
   /**
     ...
     * @throws java.util.NoSuchElementException if standard input is empty
     * @throws java.util.InputMismatchException if the next token cannot be parsed as a {@code float}
     */
   ...
   /**
     ...
     * @throws java.util.NoSuchElementException if standard input is empty
     * @throws java.util.InputMismatchException if the next token cannot be parsed as a {@code long}
     */
   ...
   /**
     ...
     * @throws java.util.NoSuchElementException if standard input is empty
     * @throws java.util.InputMismatchException if the next token cannot be parsed as a {@code short}
     */
   ...
   /**
     ...
     * @throws java.util.NoSuchElementException if standard input is empty
     * @throws java.util.InputMismatchException if the next token cannot be parsed as a {@code byte}
     */
     ...
     * @throws java.util.NoSuchElementException if standard input is empty
     * @throws java.util.InputMismatchException if the next token cannot be parsed as a {@code boolean}:
     ...
     * @throws java.util.InputMismatchException if any token cannot be parsed as an {@code int}
     */
     ...
     * @throws java.util.InputMismatchException if any token cannot be parsed as a {@code long}
     */
     ...
     * @throws java.util.InputMismatchException if any token cannot be parsed as a {@code double}
     */
