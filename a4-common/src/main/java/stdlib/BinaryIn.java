...
public final class BinaryIn {
   ...
   /**
     ...
     * @throws java.util.NoSuchElementException if this binary input stream is empty
     */
   ...
   /**
     ...
     * @throws java.util.NoSuchElementException if there are fewer than 8 bits available
     */
   ...
   /**
     ...
     * @throws java.util.NoSuchElementException if there are fewer than {@code r} bits available
   ...
   /**
     ...
     * @throws java.util.NoSuchElementException if this binary input stream is empty or if the number of bits
   ...
   /**
     ...
     * @throws java.util.NoSuchElementException if there are fewer than 16 bits available
     */
   ...
   /**
     ...
     * @throws java.util.NoSuchElementException if there are fewer than 32 bits available
     */
    public int readInt() {
        int x = 0;
        for (int i = 0; i < 4; i++) {
   ...
   /**
     ...
     * @throws java.util.NoSuchElementException if there are fewer than r bits available
   ...
   /**
     ...
     * @throws java.util.NoSuchElementException if there are fewer than 64 bits available
     */
